				...
				<div className="row">
					<div className="col-lg-7">
						<div className={styles.heroContent}>
							...
							<p className={`mt-5 ${styles.heroText}`}>Create professional email signatures and improve the quality of your email send with actionable call-toactions.</p>

							<div className="mt-5 mb-lg-0 mb-5 float-lg-end float-start">
								<Link to="/email-signature-details" className="pri-btn fs-4">
									Get Started
								</Link>
							</div>
						</div>
