			...
			<GuidesContainer>
				<GuidesButton>
					<ImageContainer>
						<ImageDiv>
							<div>
								<Img width="25px" height="25px" src={library_books} alt="docs" />
							</div>
						</ImageDiv>
					</ImageContainer>
					<GuideHeader>Read Our Docs</GuideHeader>
					<GuidePara>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Senectus turpis condimentum scelerisque</GuidePara>
				</GuidesButton>
				<GuidesButton>
					<ImageContainer>
						<ImageDiv2>
