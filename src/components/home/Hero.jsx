								...
								<div className="row">
									<div className="col-lg-7">
										<div className={styles.heroText}>
											<h1 className="text-uppercase sec-color">take control with kreativerock technology</h1>
								...
								<div className="row">
									<div className="col-lg-7">
										<div className={styles.heroText}>
											...
											<p>Explore our custom email signature templates,drag-and drop editor and increase your email clickability.</p>
											<Link to="#">
						...
						<div className={styles.thridHero}>
							<div className="container">
								<div className="row">
									<div className="col-lg-7">
										<div className={styles.heroText}>
											<h1 className="pri-color">SCALE YOUR BUSINESS WITH TECHNOLOGY.</h1>
											<p>The beauty of the world is the technology that is driving it.</p>
											<Link to="#">
												<img width="300" src={HeroBtn2} alt="home hero btn" />
											</Link>
										</div>
						...
						<div className={styles.fourthHero}>
							<div className="container">
								<div className="row">
									<div className="col-lg-7">
										<div className={styles.heroText}>
											<h1 className="sec-color">ATTRACT THE RIGHT COUSTOMERS.</h1>
											<p>Effective branding, digital advertising & content marketing is all you need to maximize market opportunities.</p>
											<Link to="#">
												<img width="300" src={HeroBtn2} alt="home hero btn" />
											</Link>
										</div>
