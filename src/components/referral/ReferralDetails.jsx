      ...
      <div className="row">
        <div className="col-lg-2">
          <div className="d-flex justify-content-between">
            <div
              style={{ backgroundImage: `url(${RefPic})` }}
              className={`mt-2 ${styles.referralDetailsImg}`}
            ></div>
            <div className={`d-lg-none d-block ${styles.priceBox}`}>
              $100 Credit
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-7">
          <div className="text-white">
            <div className={styles.referralDetailsHeader}>
