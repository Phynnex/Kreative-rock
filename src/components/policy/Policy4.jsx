  ...
  return (
    <div className={styles.policySection}>
      ...
      <h2>
        ...
        or receive about you broadly falls into the following categories:
      </h2>
      <h2 className="text-center">
        • Information we receive about Contacts from our Subscribers:{" "}
      </h2>
      <p>
        A Subscriber may provide Personal Information about you to us through
      ...
      <p>
        We collect information about the device and applications you use to
        access content sent through our Service, such as your IP address, your
        operating system, your browser ID, and other information about your
        system and connection.
      </p>
      <h2>• Usage Data: </h2>
      <p>
        It is important for us to ensure the security and reliability of the
        Service we provide. Therefore, we also collect usage data about your
        interactions with campaigns (and/or emails) and other content delivered
        through the Service, which may include dates and times you access
        campaigns (and/or emails) and your browsing activities (such as what
        pages are viewed, which emails are opened, and how you respond to
        surveys). This information also allows us to provide our Service, ensure
        compliance with our Standard Terms of Use and Acceptable Use Policy, to
        monitor and prevent service abuse, and to ensure we attain certain usage
        standards and metrics in relation to our Service. We also collect
        information regarding the performance of the Service, including metrics
        related to the deliverability of emails and other electronic
        communications that our Subscribers send through the Service. This
      ...
      <p>
        ...
        sources, such as social media platforms, and third-party data providers.
      </p>
      ...
      <p>
        ...
        law. This may include utilizing usage data and developing tools and
      ...
      <p>
        {" "}
        • To provide, support and improve the Service. For example, this may
        include sharing your information with third parties in order to provide
        and support our Service or to make certain features of the Service
        available to our Subscribers. When we share Personal Information with
        third parties, we take steps to protect your information in a manner
        that is consistent with applicable privacy laws.
      </p>{" "}
      <p>
        {" "}
        • To perform data analytics projects, our data analytics projects use
        data from KreativeRock accounts, including your Personal Information, to
        provide and improve the Service. We use information, like your purchase
        history, provided to us by Subscribers, so we can make more informed
        predictions, decisions, and products for our Subscribers. For example,
        we use data from KreativeRock accounts to enable product recommendation,
        audience segmentation, and predicted demographics features for our
        Subscribers. If you prefer your data not to be used in this manner, you
        can opt out of data analytics projects at any time.
      </p>
      <p>
        {" "}
