  ...
  const messageData = [
    {
      ...
      message:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dictum amet, senectus aliquet scelerisque nisl pellentesque velitcommodo quis. Commodo sagittis sed rhoncus sed arcu.",
      received: "10am - 11pm",
    },
          ...
          {messageData.map((val, key) => {
            return (
              <div className="mt-5">
                ...
                <div
                  className={`d-flex justify-content-between flex-wrap mt-3 ${styles.messageWrapper}`}
                >
