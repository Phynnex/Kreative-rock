...
function SenderIdListTable() {
	...
	return (
		<>
			<EditSenderIdForm isOpen={isOpen} detail={sendaID} close={handleCloseEditForm} />
							...
							{senderId?.payload?.map((id, i) => (
								<tr key={(id, i)}>
									...
									<td>
										...
										{details === i && (
											<TableDetailsPageModal show={details === i ? true : false} onClick={() => handleSelectItemEdit(id)}>
												<TablePopupDiv>
